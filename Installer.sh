...
# Installer script for nmap, its dependencies, and Whois tool

# Define variables
TOOL_DIR="/usr/local/src/nmap_tool"
REPO_URL="https://github.com/nmap/nmap.git"
WHOIS_SCRIPT_URL="https://raw.githubusercontent.com/yourusername/yourrepo/main/whois_tool.py"
...
echo "python3 /usr/local/bin/whois_tool.py <domain>"
